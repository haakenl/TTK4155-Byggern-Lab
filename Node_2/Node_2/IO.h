...
/* Set up MJ1 */
#define disable_encoder	PIOD -> PIO_SODR |= PIO_SODR_P0;	// !OE disable encoder (Pin3)
#define enable_encoder PIOD -> PIO_CODR |= PIO_SODR_P0;		// !OE enable encoder (Pin3)
...
#define sel_LSB_encoder	PIOD -> PIO_SODR |= PIO_SODR_P2;	// SEL MEB encoder (Pin5)
...
#define set_pos_motor_dir PIOD -> PIO_SODR |= PIO_SODR_P10;		// set pos dir motor (Pin7)
#define set_neg_motor_dir PIOD -> PIO_CODR |= PIO_SODR_P10;		// set neg dir motor (Pin7) Må muligens snus!

/* Set up MJ2 */
//#define MJ2_D0 (PIOC -> PIO_PDSR_P0);
